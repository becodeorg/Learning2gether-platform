...
final class Version20191023141931 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD language_id INT NOT NULL, ADD password_hash VARCHAR(255) NOT NULL, ADD is_partner TINYINT(1) NOT NULL, ADD badgr_key VARCHAR(255) NOT NULL, ADD username VARCHAR(255) NOT NULL, ADD avatar VARCHAR(255) DEFAULT NULL, ADD created DATETIME NOT NULL DEFAULT GETDATE()');
